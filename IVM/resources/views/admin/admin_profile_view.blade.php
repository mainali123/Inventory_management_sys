            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card"><br> <br>
                        <center>
                        <img class="rounded-circle avatar-xl" src="{{ (!empty($admin_Data->profile_picture))? url('upload/admin_images/'.$admin_Data->profile_picture):url('upload/no_image.jpg') }}" alt="Card image cap">
                        </center>
                            <div class="card-body">
